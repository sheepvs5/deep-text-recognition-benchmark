...
if __name__ == '__main__':
    ...
    #                     default=' %\'()+,-./0123456789:@ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz', help='character label')
    parser.add_argument('--character', type=str,
                        default=' %\'()+,-./0123456789:@_abcdefghijklmnopqrstuvwxyz', help='character label')
